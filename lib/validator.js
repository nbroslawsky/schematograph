...
Validator.prototype = {
					...
					results[field] = Object.keys(fieldConfig)
						.reduce(function(init, funcName) {
							...
							var validator = self.validators[funcName],
								v = validator ? !!validator.call(self, fieldConfig[funcName], data && data[field], data, field) : true;
							localSuccess &= v;
							init[funcName] = v;
	...
	validators : {
		...
		populate : function(target, value, parent, field) {
			if(value === undefined)
				parent[field] = target;
			return true;
		},
		populateMissing : function(target, value, parent, field) {
